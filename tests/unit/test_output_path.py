...
def test_resolve_dub_sidecar_strips_bilingual_stem():
    out = Path(r"D:/exports/talk-中英字幕.mp4")
    srt = Path(r"D:/exports/talk-中英字幕.bilingual.srt")
    assert resolve_dub_sidecar(out, srt) == sidecar_dub(out)
    assert resolve_dub_sidecar(None, srt) == Path(r"D:/exports/talk-中英字幕-dub.mp4")
    assert resolve_dub_sidecar(None, Path(r"D:/exports/o.srt")) == Path(r"D:/exports/o-dub.mp4")
